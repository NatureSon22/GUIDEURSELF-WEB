      ...
      <div className={`${isDarkMode ? 'bg-gray-800' : 'bg-white'} p-6 rounded-md w-1/3`}>
        <div className="flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-2">
            ...
            >
              <option className={`${isDarkMode ? 'text-white' : 'text-gray-800'}`} value="" disabled hidden>
                Select Program Name
              </option>
          ...
          <div className="flex flex-col border border-gray-300 rounded-md p-4">
            ...
            <Label className={`${isDarkMode ? 'text-white' : 'text-gray-800'} text-lg font-medium mb-2 mt-6`}>Major in:</Label>
