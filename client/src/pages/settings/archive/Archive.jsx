      ...
      <div className="flex">
        {tabs.map((tab, tabIndex) => {
          return (
            <div
              key={tab}
              className={`cursor-pointer rounded-t-lg px-5 py-3 text-[0.95rem] transition-colors duration-150 ${selectedArchive === tabIndex ? "border-b-4 border-base-200 bg-base-200/10 text-base-200" : isDarkMode ? "text-dark-text-base-300-75 hover:bg-secondary-200/30" : "hover:bg-secondary-200/30"}`}
