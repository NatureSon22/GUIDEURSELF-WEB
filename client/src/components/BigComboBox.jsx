...
const BigComboBox  = React.forwardRef(
  (
    {
      options = [],
      placeholder = "Select",
      ...
      <Popover open={open} onOpenChange={setOpen}>
        <PopoverTrigger asChild>
          <Button
            ...
            role="combobox"
            aria-expanded={open}
            className={`${style?.width || "w-[550px]"} ${style?.py || ""} justify-between ${
              selectedValue
                ? "text-base-300"
        ...
        <PopoverContent className={`${style?.width || "w-[550px]"} p-0`}>
          <Command>
            <CommandList>
...
BigComboBox.displayName = "BigComboBox";

export default BigComboBox;
